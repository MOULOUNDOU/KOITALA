        ...
        <>
          ...
          <div className="md:hidden fixed top-14 left-0 bottom-0 w-64 bg-[#0f1724] z-40 overflow-y-auto">
            ...
            <div className="px-3 py-4 border-t border-white/10">
              <Link href="/" target="_blank" onClick={() => setMobileOpen(false)} className="flex items-center gap-3 px-3 py-3 rounded-xl text-sm text-gray-400 hover:text-white hover:bg-white/5 transition-all mb-1">
