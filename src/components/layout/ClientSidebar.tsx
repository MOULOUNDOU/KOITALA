...
const clientProfileHref = "/dashboard-client/parametres";
const clientAssistantHref = "/assistant-ia";
    ...
    <>
      ...
      <aside
        className={cn(
          ...
          desktopOpen ? "w-[252px] px-3" : "w-[72px] px-2"
        )}
        onMouseEnter={() => {
      ...
      >
        ...
        <Link
          ...
          aria-label="Ouvrir le profil client"
          className={cn(
        ...
        <nav className={cn("flex flex-1 flex-col gap-1.5", desktopOpen ? "items-stretch" : "items-center")}>
          {navItems.map((item) => (
      ...
      <div
        className={cn(
          "md:hidden fixed top-14 left-0 bottom-0 w-64 bg-[#1a3a5c] z-40 overflow-hidden overscroll-none transition-transform duration-300 ease-out",
      ...
      >
        ...
        <div className="px-3 py-4 border-t border-white/10">
          ...
          >
            <Bot className="w-5 h-5" /> Assistant IA
          </Link>
          <Link
            href="/"
            target="_blank"
