...
-- Create profile only after the auth account is confirmed.
-- This avoids polluting public.profiles with users who started signup
-- but never validated their email address.
